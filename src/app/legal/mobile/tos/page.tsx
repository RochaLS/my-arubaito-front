...
export default function Page() {
    ...
    return (
        <Box padding="4" maxW="3xl" mx="auto">
            ...
            <Text mt="2">
            By accessing and using Baito (the “Service”), you accept and
            ...
            <Text mt="2">
            Baito is a mobile application designed to help part-time workers
            ...
            <Text mt="2">
            Baito offers an AI import schedule functionality that allows
            ...
            Baito is not liable for any errors, omissions, or inaccuracies that
